...
function HeaderSingle({ className = '', scroll = false }) {
    ...
    return (
        ...
        <header id='home' className={`main-header header-style-five ${className || ''}`}>
            <div className="header-lower">
                <div className="auto-container main-box px-xxl-4">
                    <div className="logo-box">
                        <div className="logo">
                            <Link to="/">
                                <img src={isDarkMode ? LogoWhite : LogoDark} alt="Techon" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="outer-box">
                        <button className="ui-btn ui-btn search-btn" onClick={toggleSearchPopup}><span className="icon lnr lnr-icon-search" /></button>
