...
import MainLogoDark from '../../assets/images/logo-2.png';
                ...
                <div className="inner-container">
                    <div className="top-left">
                        <ul className="list-style-one light">
                            <li><i className="fa fa-phone" /><Link to="/" className="tel:0123456789">+012 3456789</Link></li>
                            <li><i className="fa fa-envelope" /><Link to="/" className="mailto:needhelp@company.com">needhelp@company.com</Link></li>
                            <li><i className="fa fa-map-marker" />88 Broklyn Golden Street. New York</li>
                        </ul>
                    </div>
                    <div className="top-right">
                        <div className="text">Welcome to IT Solutions & Services</div>
                    </div>
                </div>
            </div>
            <div className="header-lower">
                <div className="main-box">
                    <div className="logo-box">
                        <div className="logo">
                            <Link to="/">
                                <img src={isDarkMode ? MainLogoDark : MainLogo} alt="Techon" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="outer-box">
                        <ul className="social-icon-one">
                            ...
                            <li><Link to="/"><i className="icon fab fa-facebook" /></Link></li>
                            <li><Link to="/"><i className="icon fab fa-pinterest-p" /></Link></li>
                            <li><Link to="/"><i className="icon fab fa-instagram" /></Link></li>
                        </ul>
                        <div className="btn-box"><Link to="page-contact" className="theme-btn btn-style-two"><span className="btn-title">Get a Free Quote</span></Link></div>
