...
function HeaderSingle({ className = '', scroll = false }) {
    ...
    return (
        ...
        <header id='home' className={`main-header header-style-one ${className || ''}`}>
                ...
                <div className="main-box">
                    ...
                    <div className="outer-box">
                        <div className="ui-btn-outer">
                            ...
                            <Link to="/" className="ui-btn cart-btn"><i className="lnr-icon-shopping-cart" /></Link>
                        </div>
                        <Link to="/" className="info-btn ui-info-btn">
                            <i className="icon fas fa-phone" />
                            <small>Call Anytime</small>+ 01 (2345) 6789
                        </Link>
